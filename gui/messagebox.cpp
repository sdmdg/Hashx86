...
MessageBox::MessageBox(CompositeWidget* parent, const char* title, const char* message, Type type, int* resultPtr)
    ...
    if (type == INFO) {
        ...
        okButton->OnClick(this, [](void* instance) {
        static_cast<Window*>(instance)->OnCloseButton();});
