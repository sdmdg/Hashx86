...
MemoryViewer::MemoryViewer()
{
    ...
    btn_backspace = new Button(mainWindow, LEFT_PADDING + 4*40, (TOP_PADDING + 1*35), 75, 30, "BACK");

    // Control buttons
    btn_clear = new Button(mainWindow, LEFT_PADDING + 0*40, (TOP_PADDING + 0*45), 65, 30, "CLEAR");
    ...
    btn_0->OnClick(this, [](void* instance) { static_cast<MemoryViewer*>(instance)->onPressHex('0'); });
    btn_1->OnClick(this, [](void* instance) { static_cast<MemoryViewer*>(instance)->onPressHex('1'); });
    btn_2->OnClick(this, [](void* instance) { static_cast<MemoryViewer*>(instance)->onPressHex('2'); });
    btn_3->OnClick(this, [](void* instance) { static_cast<MemoryViewer*>(instance)->onPressHex('3'); });
    btn_4->OnClick(this, [](void* instance) { static_cast<MemoryViewer*>(instance)->onPressHex('4'); });
    btn_5->OnClick(this, [](void* instance) { static_cast<MemoryViewer*>(instance)->onPressHex('5'); });
    btn_6->OnClick(this, [](void* instance) { static_cast<MemoryViewer*>(instance)->onPressHex('6'); });
    btn_7->OnClick(this, [](void* instance) { static_cast<MemoryViewer*>(instance)->onPressHex('7'); });
    btn_8->OnClick(this, [](void* instance) { static_cast<MemoryViewer*>(instance)->onPressHex('8'); });
    btn_9->OnClick(this, [](void* instance) { static_cast<MemoryViewer*>(instance)->onPressHex('9'); });
    btn_a->OnClick(this, [](void* instance) { static_cast<MemoryViewer*>(instance)->onPressHex('A'); });
    btn_b->OnClick(this, [](void* instance) { static_cast<MemoryViewer*>(instance)->onPressHex('B'); });
    btn_c->OnClick(this, [](void* instance) { static_cast<MemoryViewer*>(instance)->onPressHex('C'); });
    btn_d->OnClick(this, [](void* instance) { static_cast<MemoryViewer*>(instance)->onPressHex('D'); });
    btn_e->OnClick(this, [](void* instance) { static_cast<MemoryViewer*>(instance)->onPressHex('E'); });
    btn_f->OnClick(this, [](void* instance) { static_cast<MemoryViewer*>(instance)->onPressHex('F'); });

    // Set up control button handlers
    btn_clear->OnClick(this, [](void* instance) { static_cast<MemoryViewer*>(instance)->onPressClear(); });
    btn_backspace->OnClick(this, [](void* instance) { static_cast<MemoryViewer*>(instance)->onPressBackspace(); });

    // Set up size button handlers
    btn_byte->OnClick(this, [](void* instance) { static_cast<MemoryViewer*>(instance)->onPressSize(1); });
    btn_word->OnClick(this, [](void* instance) { static_cast<MemoryViewer*>(instance)->onPressSize(2); });
    btn_dword->OnClick(this, [](void* instance) { static_cast<MemoryViewer*>(instance)->onPressSize(4); });
...
void MemoryViewer::onPressRead()
{
    ...
    switch (readSize) {
        case 1: // Byte
            value = *memPtr;
            valueStr[0] = 'B'; valueStr[1] = 'y'; valueStr[2] = 't'; valueStr[3] = 'e';
            valueStr[4] = ':'; valueStr[5] = ' '; valueStr[6] = '0'; valueStr[7] = 'x';
        ...
        case 2: // Word
            ...
            valueStr[0] = 'W'; valueStr[1] = 'o'; valueStr[2] = 'r'; valueStr[3] = 'd';
            valueStr[4] = ':'; valueStr[5] = ' '; valueStr[6] = '0'; valueStr[7] = 'x';
        ...
        case 4: // Dword
            ...
            valueStr[0] = 'D'; valueStr[1] = 'w'; valueStr[2] = 'o'; valueStr[3] = 'r';
            valueStr[4] = 'd'; valueStr[5] = ':'; valueStr[6] = ' '; valueStr[7] = '0'; valueStr[8] = 'x';
