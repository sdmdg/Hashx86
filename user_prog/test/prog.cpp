...
Calculator::Calculator()
{
    ...
    btn_multiplication = new Button(mainWindow, LEFT_PADDING + 3*50, (TOP_PADDING + 1*40), 40, 30, "*");
    ...
    btn_division = new Button(mainWindow, LEFT_PADDING + 3*50, (TOP_PADDING + 0*40), 40, 30, "/");
    ...
    btn_0->OnClick(this, [](void* instance) {
        static_cast<Calculator*>(instance)->onPressNum(0);
    });
    btn_1->OnClick(this, [](void* instance) {
        static_cast<Calculator*>(instance)->onPressNum(1);
    });
    btn_2->OnClick(this, [](void* instance) {
        static_cast<Calculator*>(instance)->onPressNum(2);
    });
    btn_3->OnClick(this, [](void* instance) {
        static_cast<Calculator*>(instance)->onPressNum(3);
    });
    btn_4->OnClick(this, [](void* instance) {
        static_cast<Calculator*>(instance)->onPressNum(4);
    });
    btn_5->OnClick(this, [](void* instance) {
        static_cast<Calculator*>(instance)->onPressNum(5);
    });
    btn_6->OnClick(this, [](void* instance) {
        static_cast<Calculator*>(instance)->onPressNum(6);
    });
    btn_7->OnClick(this, [](void* instance) {
        static_cast<Calculator*>(instance)->onPressNum(7);
    });
    btn_8->OnClick(this, [](void* instance) {
        static_cast<Calculator*>(instance)->onPressNum(8);
    });
    btn_9->OnClick(this, [](void* instance) {
        static_cast<Calculator*>(instance)->onPressNum(9);
    });

    btn_dot->OnClick(this, [](void* instance) {
        static_cast<Calculator*>(instance)->onPressFunc('.');
    });
    btn_plus->OnClick(this, [](void* instance) {
        static_cast<Calculator*>(instance)->onPressFunc('+');
    });
    btn_solve->OnClick(this, [](void* instance) {
        static_cast<Calculator*>(instance)->onPressFunc('=');
    });
    btn_minus->OnClick(this, [](void* instance) {
        static_cast<Calculator*>(instance)->onPressFunc('-');
    });
    btn_multiplication->OnClick(this, [](void* instance) {
        static_cast<Calculator*>(instance)->onPressFunc('*');
    });
    btn_division->OnClick(this, [](void* instance) {
        static_cast<Calculator*>(instance)->onPressFunc('/');
    });
    
    btn_clear->OnClick(this, [](void* instance) {
        static_cast<Calculator*>(instance)->clearCalculator();
    });
